...
- <a href="#what-it-is">What it is</a> · <a href="#why-its-different">Why it's different</a>
- <a href="#using-the-app">Using the app</a> · <a href="#configure-the-ai">Configure the AI</a>
